    ...
    while y < 8000:
        ...
        if holder != "":
            if holder in dictionaryofoccurances['state']:
                ...
                dictionaryofoccurances['occurences'][secondholder] = dictionaryofoccurances['occurences'][secondholder] + 1
            else:
            ...
            if stateholder != "":
                ...
                if yearholder in yeardictionary:
                    if stateholder in yeardictionary[yearholder]["state"]:
                        ...
                        yeardictionary[yearholder]["occurances"][indexholder]= yeardictionary[yearholder]["occurances"][indexholder] + 1
                    else:
...
def ufoduration(minimumsecond=80,maximumsecond=300,state1="oh",state2="nc"):
    ...
    durationpanda = durationpanda[(durationpanda["duration"] >= minimumsecond) & (durationpanda["duration"] <= maximumsecond) & (durationpanda["state"].isin([state1,state2]))]
...
maindropdown = st.selectbox("",("","Most Common Shapes of UFO","5 US states with most sightings", "Top 5 Occurances by Year","UFO Sighting duration analysis","california sightings map"))
...
if maindropdown == "UFO Sighting duration analysis":
    ...
    firststate = st.selectbox("Please select your first state:",("","al","ak","az","ar","ca","co","ct","de","fl","ga","hi","id","il","in","ia","ks","ky","ka","me","md","ma","mi","mn","ms","mo","mt","ne","nv","nh","nj","nm","ny","nd","oh","ok","or","pa","ri","sc","sd","tn","tx","ut","vt","va","wa","wv","wi","wy"),key=1)
    secondstate = st.selectbox("Please select your first state:",("","al","ak","az","ar","ca","co","ct","de","fl","ga","hi","id","il","in","ia","ks","ky","ka","me","md","ma","mi","mn","ms","mo","mt","ne","nv","nh","nj","nm","ny","nd","oh","ok","or","pa","ri","sc","sd","tn","tx","ut","vt","va","wa","wv","wi","wy"),key=2)
